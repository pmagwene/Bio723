...
\subtitle{Data as Vectors: Geometry of Bivariate Relationships} % (optional)
...
\item We are looking, therefore, for the scalar multiple, $\bar{x}$, of the unit vector that minimizes $|\vec{\mathbf{x}}-\vec{\mathbf{1}}\bar{x}|^2 = |\vec{e}|$
